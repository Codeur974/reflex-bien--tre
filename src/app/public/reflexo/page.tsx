      ...
      <div className={Styles.reflexo__content}>
        ...
        <div className={Styles.reflexo__energetiqueSection}>
          ...
          >
            ...
            <polygon points="400,180 561.7,297.5 499.9,487.5 300.1,487.5 238.3,297.5"
                     fill="none" stroke="#004b8d" strokeWidth="4"/>

            <polyline points="400,180 499.9,487.5 238.3,297.5 561.7,297.5 300.1,487.5 400,180"
                      fill="none" stroke="#ff7f9d" strokeWidth="2" strokeDasharray="6,6"/>

            <circle cx="400" cy="110" r="45" fill="#ff8080"/>
            <text x="400" y="103" className="circle-label" fill="#ffffff">FEU</text>
            <text x="400" y="125" className="circle-season" fill="#ffffff">Été</text>
            <text x="400" y="175" className="title">
              Cœur / Intestin Grêle · Système nerveux central et cardio-vasculaire
            </text>

            <circle cx="140" cy="300" r="45" fill="#c7e8a2"/>
            <text x="140" y="293" className="circle-label">BOIS</text>
            <text x="140" y="317" className="circle-season">Printemps</text>
            <text x="20" y="360" className="text-block">
              Système articulo-musculaire
            </text>
            <text x="20" y="387" className="text-block">
              Foie / Vésicule biliaire
            </text>

            <circle cx="670" cy="300" r="45" fill="#ffe58a"/>
            <text x="670" y="293" className="circle-label">TERRE</text>
            <text x="670" y="317" className="circle-season">Fin de l&apos;été</text>
            <text x="670" y="339" className="circle-season">Intersaisons</text>
            ...
            <circle cx="260" cy="600" r="45" fill="#c7ddff"/>
            <text x="260" y="593" className="circle-label">EAU</text>
            <text x="260" y="617" className="circle-season">Hiver</text>
            <text x="130" y="657" className="text-block">
              Système uro-génital
            </text>
            <text x="130" y="684" className="text-block">
              Rein / Vessie
            </text>

            <circle cx="540" cy="600" r="45" fill="#d9d9d9"/>
            <text x="540" y="593" className="circle-label">METAL</text>
            <text x="540" y="617" className="circle-season">Automne</text>
            <text x="580" y="657" className="text-block">
              Système respiratoire
            </text>
            <text x="580" y="684" className="text-block">
        ...
        <p className={Styles.reflexo__text}>
          Une séance vous apportera une <strong>détente profonde</strong>.
        </p>
        <p className={Styles.reflexo__text}>
